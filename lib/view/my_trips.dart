  ...
  Widget build(BuildContext context) {
    return Scaffold(
                ...
                Get.defaultDialog(
                    ...
                    content: Column(
                      children: [
                        TextButton.icon(
                            onPressed: () async {
                              currentUserInfos.currentUserTrips
                                  ?.sort(
                                (a, b) {
        ...
        body: Builder(builder: (context) {
          ...
          if (currentUserInfos.currentUserTrips!.isEmpty) {
            return const Center(
            ...
            return ListView.separated(
              ...
              shrinkWrap: true,
              itemCount: currentUserInfos.currentUserTrips!.length,
                        ...
                        Row(
                          ...
                          children: [
                            Column(
                              ...
                              children: [
                                Text(currentUserInfos
                                    .currentUserTrips![index].departure!),
                                SizedBox(
                                  height: 60,
                                  width: 40,
                                  child: Stack(
                                ...
                                Text(currentUserInfos
                                    .currentUserTrips![index].destination!),
                              ],
                            ),
                            Column(
                              ...
                              children: [
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                        "${currentUserInfos.currentUserTrips![index].price} DA")
                                  ],
                                ),
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                        "${currentUserInfos.currentUserTrips![index].allSeats}")
                                  ],
                                ),
                                const SizedBox(height: 5),
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                        "${currentUserInfos.currentUserTrips![index].seatsLeft}")
                                  ],
                                )
                              ],
                            ),
                            ...
                            if (currentUserInfos
                              ...
                              return Column(
                                ...
                                children: [
                                  const Divider(thickness: 3),
                                  Text(
                                    "Condition : ${currentUserInfos.currentUserTrips![index].condition}",
                                    style: const TextStyle(fontSize: 16),
                                  ),
                                ],
                              );
